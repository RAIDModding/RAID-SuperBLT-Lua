...
--	 0.9.40 Changed license to MIT License (MIT)
...
-- @return Lua object that was scanned, as a Lua table / string / number / boolean or nil.
function decode(s)
...
do
	...
	function decode(js_string)
		-- Hacky fix for loading empty objects crashing the game
		if js_string == "[]" then
			return {}
		end
